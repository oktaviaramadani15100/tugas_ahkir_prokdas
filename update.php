...
<div class="container-1">
        ...
        <ul>
           ...
           <p><i class="fa-solid fa-square-pen"></i> <a href="update.php">Berita Update</a></i></p> 
        </ul>
    </div>
    </div>
                ...
                <?php
                    ...
                    while($pel=mysqli_fetch_array($query)){
                        echo"
                            <tr>
                                <td>$pel[nomer]</td>
                                <td><img src='foto/$pel[gambar]' width='200px'></td>
                                <td>$pel[berita]</td>
                                <td>$pel[isi]</td>
                                <td>$pel[tanggal_kejadian]</td>
                                <td>$pel[tanggal_update]</td>
                                <td>
                                <a href='form-edit-update.php?nomer=".$pel['nomer']."'><button class='merah'>Update</button></a>
